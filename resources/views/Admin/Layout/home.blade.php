                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title">Người truy cập cửa hàng trực tuyến</h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <p class="d-flex flex-column">
                                    ...
                                    <span>Khách đến theo thời gian</span>
                                </p>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <p class="d-flex flex-column">
                                    ...
                                    <span>Doanh số theo thời gian</span>
                                </p>
                                <p class="ml-auto d-flex flex-column text-right">
                                    <span class="text-success">
                            ...
                            <div class="d-flex flex-row justify-content-end">
                                ...
                                <span>
                                    <i class="fas fa-square text-gray"></i> Nắm trước
                                </span>
                            </div>
                        </div>
                    </div>
