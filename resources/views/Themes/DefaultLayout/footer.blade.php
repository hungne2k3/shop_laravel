        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="#" class="stext-107 cl7 hov-cl1 trans-04">
                            ➡️ Chính sách bán hàng, thanh toán và đổi trả
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="#" class="stext-107 cl7 hov-cl1 trans-04">
                            ➡️ Chính sách vận chuyển, giao hàng
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="#" class="stext-107 cl7 hov-cl1 trans-04">
                            ➡️ Chính sách quyền riêng tư
                        </a>
                    </li>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    - Địa chỉ (Showroom): 73 Nguyễn Văn Lạc, Phường 19, quận Bình Thạnh, thành phố Hồ Chí Minh (Lầu 1)
                    - Hotline: 0986 604 006 (Ms.Thư)
                    - Ship toàn quốc miễn phí - Giao nhanh 30p - Nhận hàng mới thanh toán COD
                </p>
